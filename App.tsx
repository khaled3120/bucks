...
const FAQS = [
  ...
  },
  {
    ...
    answer: "Once your deals are verified, your Starbucks voucher code will be delivered to your email within 24\u201348 hours."
  }
];
...
export default function App() {
  return (
    <>
      ...
      {/* Top Banner */}
      <div className="w-full bg-[#00704A] text-white text-center py-2 text-[11px] font-bold tracking-widest uppercase">
      ...
      <main className="flex-1 flex flex-col items-center w-full max-w-[400px] mx-auto px-4 pt-6 pb-8">
        ...
        {/* Logo */}
        <div className="h-[76px] mb-5 mt-1 flex justify-center items-center w-full">
          <img
        ...
        <p className="text-gray-600 text-center mb-6 text-[13px]">
          Claim your <span className="font-bold text-black">$750</span> Starbucks voucher
        </p>
        ...
        <div className="w-full flex flex-col gap-2.5 mb-7">
          {STEPS.map((step, index) => (
            ...
            >
              <div className="w-8 h-8 rounded-full bg-[#00704A] text-white border-[1.5px] border-[#00704A] flex items-center justify-center font-bold text-[13px] shrink-0 ml-3.5 mr-3.5">
                {index + 1}
              </div>
        ...
        <button 
          ...
          className="w-full bg-[#00704A] hover:bg-[#005e3e] active:bg-[#004d33] transition-colors text-white font-bold text-[15.5px] py-3.5 rounded-full shadow-[0_4px_14px_0_rgba(0,112,74,0.39)] hover:shadow-[0_6px_20px_rgba(0,112,74,0.23)] active:scale-[0.98] text-center block"
        >
          CLAIM NOW
        </button>
